package com.example.adsrestapi.filter;
...
public class JWTAuthFilter extends OncePerRequestFilter {
    ...
    public JWTAuthFilter(AdvantisUserDetailsService advantisUserDetailsService,
                         JWTManagementUtilityService jwtManagementUtilityService) {
        this.advantisUserDetailsService = advantisUserDetailsService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(username != null
            ...
            UserDetails userDetails = advantisUserDetailsService.loadUserByUsername(username);
