...
//    }
//
//    public static void printStarSupplier(List<Supplier> suppliers, double totalValueThreshold) {
//        suppliers.stream()
//                .filter(supplier -> supplier.isStarSupplier(totalValueThreshold))
//                .sorted(Comparator.comparing(Supplier::getName))
//                .forEach(System.out::println);
//    }
//
...
//
//        Supplier supplier1 = new Supplier(1L, "Google, Inc.", null,
//                3128874119L, "Pixel 8 Pro", LocalDate.of(2023, 01, 24), 124, 1599.55
//        );
//
//
//        Supplier supplier2 = new Supplier(2L,
//                "Apple, Inc.", "(641) 123-0987",
//                {
//                        2927458265L, "iPad 14 Pro", LocalDate.of(2022, 12, 9), 18, 1700.09),
//                }
//                2927458265L, "iPad 14 Pro", LocalDate.of(2022, 12, 9), 18, 1700.09);
//
//        supplier2.addProduct(2927458266L, "iPhone 15", LocalDate.of(2023, 10, 11), 95, 1650.85);
//
//
//        Supplier supplier3 = new Supplier(3L, "Samsung Corporation", null, null,null,null,0,0);
//        Supplier supplier4 = new Supplier(4L, "Huawei", null, null, null,null,0,0);
//
//
...
//        printStarSupplier(suppliers,100000.00);
//
